...
const emitSolutions = {
    plastic: <p>해당 사진은 플라스틱류로 보여집니다.<br /><br />
    ...
    metal: <p>해당 사진은 캔류으로 보여집니다.<br /><br />
    ...
    glass: <p>해당 사진은 유리병류로 보여집니다.<br /><br />
    ...
    clothes: <p>해당 사진은 의류로 보여집니다.<br /><br />
    ...
    cardboard: <p>해당 사진은 종이류로 보여집니다.<br /><br />
    ...
    battery: <p>해당 사진은 배터리류로 보여집니다.<br /><br />
    ...
    shoes: <p>해당 사진은 의류로 보여집니다.<br /><br />
        옷이 비교적 깨끗하고 다른 사람이 입을 수 있는 상태면 가까운 지자체 또는 민간 재활용사업자가 비치한 폐의류 전용수거함에 배출합니다.<br /><br />
        찢어졌거나 오염이 심해서 다른 사람이 입을 수 없는 상태면 일반쓰레기(종량제봉투)로 버려야합니다.<br /><br />
        많은 양의 옷을 처분해야 하거나 그냥 버리는 것이 아깝다면 의류 수거 업체에 연락해서 무게에 따라 보상을 받을 수도 있습니다.<br /><br />
        또는 각종 공익 단체나 기관에 옷을 기부해서 국내 소외계층이나 해외 빈곤 지역에 직접적인 도움을 주는 방법도 있습니다.<br /><br /></p>,
...
const UploadPage = ({ setter, setBoundboxSize, curruntView }) => {
